...
const allPersonas = [
    ...
    { gender: 'female', name: '이진아', age: 34, mbti: 'INFJ', job: '상담사', personality: ['통찰력', '따뜻함'], image: '/img/woman3_insta.webp' },
    { gender: 'female', name: '박지은', age: 29, mbti: 'ISFP', job: '디자이너', personality: ['예술적', '온화함'], image: '/img/woman4_insta.webp' },
    { gender: 'female', name: '최소희', age: 26, mbti: 'ESTP', job: '필라테스 강사', personality: ['에너제틱', '모험적'], image: '/img/woman5_insta.webp' },
    { gender: 'male', name: '한승준', age: 31, mbti: 'ISTJ', job: '개발자', personality: ['논리적', '신중함'], image: '/img/man1_insta.webp' },
    { gender: 'male', name: '박찬수', age: 29, mbti: 'ENTP', job: '스타트업 대표', personality: ['도전적', '창의적'], image: '/img/man2_insta.webp' },
    { gender: 'male', name: '김도윤', age: 32, mbti: 'INTP', job: '연구원', personality: ['분석적', '지적 호기심'], image: '/img/man3_insta.webp' },
    { gender: 'male', name: '강태오', age: 27, mbti: 'ESFP', job: '배우 지망생', personality: ['자유로운 영혼', '즉흥적'], image: '/img/man4_insta.webp' },
    { gender: 'male', name: '서지훈', age: 30, mbti: 'ISFJ', job: '수의사', personality: ['헌신적', '차분함'], image: '/img/man5_insta.webp' },
];
