...
const GlobalStyles = () => (
  <style>{`
    ...
    * {
    ...
    .main-header .logo { font-size: 28px; font-weight: 800; color: var(--text); }
    ...
    <>
      ...
      <header className="main-header">
        <div className="container">
          ...
          <a href="#" className="btn btn-login">로그인</a>
        </div>
      </header>
      ...
      <main>
        <section className="hero-section container">
            ...
            <a href="#" className="btn btn-cta reveal" style={{transitionDelay: '0.3s'}}>지금 시작하기</a>
        </section>
        ...
        <div className="cta-section reveal">
            <div className="container">
                ...
                <a href="#" className="btn btn-cta">데연소 시작하기</a>
            </div>
        </div>
      </main>
